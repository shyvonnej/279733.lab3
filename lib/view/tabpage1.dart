...
class _TabPage1State extends State<TabPage1> {
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        CachedNetworkImage(
                          ...
                          imageUrl: Config.server + "/lab3/images/" + productList[index]['prid'] + ".jpg",
  ...
  _loadProducts() {
    http.post(Uri.parse(Config.server + "/lab3/php/product.php")).then((response){
 ...
 _productDetails(int index) async {
    ...
    Navigator.push(context, MaterialPageRoute(builder: (BuildContext context) => ProductDetails(product: product))
      );
}
